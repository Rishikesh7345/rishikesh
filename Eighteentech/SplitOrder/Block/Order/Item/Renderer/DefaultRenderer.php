...
namespace Eighteentech\SplitOrder\Block\Order\Item\Renderer;
...
class DefaultRenderer extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $block = $this->getLayout()->getBlock('custom_item_unit_price');
        if (!$item) {
            $item = $this->getItem();
        }
        $block->setItem($item);
    ...
    {
        $block = $this->getLayout()->getBlock('custom_item_row_total');
        if (!$item) {
            $item = $this->getItem();
        }
        $block->setItem($item);
    ...
    {
        $block = $this->getLayout()->getBlock('custom_item_row_total_after_discount');
        if (!$item) {
            $item = $this->getItem();
        }
        $block->setItem($item);
