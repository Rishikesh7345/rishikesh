 ...
 */
namespace Eighteentech\SplitOrder\Block\Order;
...
class Items extends \Eighteentech\SplitOrder\Block\Items\AbstractItems
{
    /**
     * Core registry
     *
    ...
    protected function _prepareLayout()
    {
        ...
        $pagerBlock = $this->getChildBlock('custom_sales_order_item_pager');
        if ($pagerBlock) {
    ...
    public function getOrder()
    {
        ...
        $this->order = \Magento\Framework\App\ObjectManager::getInstance()
